document.addEventListener('DOMContentLoaded', function() {
    const products = [
       ...
       {id: 20, name: "Timberland", price: 200, image: "https://i.ibb.co/F0110dR/IMG-20240620-WA0011.jpg", description: "Timberland produces high-quality, durable outdoor footwear designed for rugged environments."},
        {id: 21, name: "Gucci", price: 200, image: "https://i.ibb.co/fCVtCJB/IMG-20240620-WA0008.jpg", description: "Blend luxurious craftsmanship with cutting-edge design."},
        {id: 22, name: "Reebok", price: 500, image: "https://i.ibb.co/chCc98r/IMG-20240624-WA0032.jpg", description: "Reebok's diverse footwear collection blends athletic performance and contemporary style."},
        {id: 23, name: "Balenciaga", price: 220, image: "https://i.ibb.co/ZT4wNCJ/IMG-20240624-WA0003.jpg" , description: "The Balenciaga footwear collection embodies the brand's timeless elegance and contemporary flair."},
        {id: 24, name: "Reebok", price: 420, image: "https://i.ibb.co/wWGfVT1/IMG-20240624-WA0026.jpg", description: "Reebok's diverse footwear collection blends athletic performance and contemporary style."},
        {id: 25, name: "Reebok", price: 420, image: "https://i.ibb.co/C6FpBFb/IMG-20240624-WA0024.jpg" , description: "This Reebok blends has athletic performance and contemporary style."},
      {id: 26, name: "Gucci", price: 400, image: "https://i.ibb.co/cDmL5Dp/IMG-20240624-WA0022.jpg" , description: "blend luxurious craftsmanship with cutting-edge design."},
        {id: 27, name: "Balenciaga", price: 200, image: "https://i.ibb.co/phXXSjM/IMG-20240624-WA0010.jpg" , description: "The Versace footwear collection embodies the brand's timeless elegance and contemporary flair."},
        {id: 28, name: "Balenciaga", price: 400, image: "https://i.ibb.co/7WmYCNZ/IMG-20240624-WA0016.jpg", description: "Blend luxurious craftsmanship with cutting-edge design for men."},
        {id: 29, name: "Versace", price: 400, image: "https://i.ibb.co/9hDyD9y/IMG-20240624-WA0020.jpg", description: "From sleek leather dress shoes to bold, statement-making sneakers, Versace footwear blends luxury and modern style."},
        {id: 30, name: "Gucci", price: 400, image: "https://i.ibb.co/cDmL5Dp/IMG-20240624-WA0022.jpg"  , description: "From sleek leather dress shoes to bold, statement-making sneakers, gucci footwear blends luxury and modern style."},
        {id: 31, name: "Gucci", price: 400, image: "https://i.ibb.co/X3YbTLT/IMG-20240624-WA0017.jpg", description: "blend luxurious craftsmanship with cutting-edge design."},
        {id: 32, name: "Dior", price: 400, image: "https://i.ibb.co/0hGf5hq/IMG-20240624-WA0013.jpg", description: "footwear offerings seamlessly blend traditional savoir-faire with modern, fashion-forward sensibilities, making them a coveted choice for the discerning style enthusiast."},
        {id: 33, name: "Gucci", price: 400, image: "https://i.ibb.co/Kj751Gc/IMG-20240624-WA0014.jpg", description: "From sleek leather dress shoes to bold, statement-making sneakers, Versace footwear blends luxury and modern style."},
        {id: 34, name: "Adidas", price: 320, image: "https://i.ibb.co/KqBrWzr/IMG-20240624-WA0030.jpg", description: "cutting-edge cushioning systems, responsive outsoles, and breathable materials, ensuring optimal comfort and performance"},
        {id: 35, name: "Gucci", price: 200, image: "https://i.ibb.co/Z27Q7vN/IMG-20240620-WA0013.jpg", description: "From classic leather dress shoes to trendy logo-embellished slides"},
        {id: 36, name: "Gucci", price: 200, image: "https://i.ibb.co/X24vbLP/IMG-20240620-WA0006.jpg" , description: "collection embodies the brand's timeless elegance and contemporary flair"},
       ];
